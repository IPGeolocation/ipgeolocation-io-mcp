...
const toolSelectionInstructionParts = [
  ...
  "Infer the minimum required output from the user request.",
  ...
  "Use include only for modules that are explicitly needed.",
  ...
  "Avoid duplicate lookups for the same input unless new required data is missing or the user asked for cross-checking.",
